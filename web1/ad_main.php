				...
				echo"<table style = 'margin-left: 40%;' >";
						...
						echo"<tbody>";
							...
							echo "<tr>";
								...
								//echo "<td>";
									//echo "<tr>";
										echo"<td><a href='delete.php?uSTT=$data[id_lop]'>Xóa</a></td>";
										echo"<td><a href='edit.php?uSTT=$data[id_lop]'>Sửa</a></td>";
									//echo "</tr>";
								//echo "</td>";
							echo "</tr>";
							}
